...
@ToString
@Entity
@Table(name = "SB_COR_COMPANY_BRANCH_DELETE")
public class BranchDelete extends Auditable {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "COMPANY_BRANCH_DELETE_SEQ")
	@SequenceGenerator(name = "COMPANY_BRANCH_DELETE_SEQ", sequenceName = "SB_COR_COMPANY_BRANCH_DELETE_SEQ", allocationSize = 1)
	private Long id;
