...
@ToString
@Entity
@Table(name = "SB_COR_COMPANY_CUMM_DATA_DELETE")
public class CompanyCummDataDelete extends Auditable {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "COMPANY_CUMM_DATA_DELETE_SEQ")
	@SequenceGenerator(name = "COMPANY_CUMM_DATA_DELETE_SEQ", sequenceName = "SB_COR_COMPANY_CUMM_DATA_DELETE_SEQ", allocationSize = 1)
	private Long id;
