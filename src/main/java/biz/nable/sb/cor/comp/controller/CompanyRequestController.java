...
//
//	Logger logger = LoggerFactory.getLogger(CompanyRequestController.class);
//	@Autowired
...
//					logger.info("Error occured while creating Company for {}.", e.getMessage());
...
//		} else {
//			try {
//				logger.debug("Update Company (CompId: {}).", updateCompanyRequest.getCompanyId());
//				if (StringUtils.isEmpty(userGroup)) {
//					userGroup = COMMON_USER_GROUP;
//				}
...
//	}
//
//	@ApiOperation(value = "Get Company By ID API", nickname = "Get Company By ID API", notes = "Get Company By ID API", httpMethod = "DELETE")
//	@ApiResponses(value = {
